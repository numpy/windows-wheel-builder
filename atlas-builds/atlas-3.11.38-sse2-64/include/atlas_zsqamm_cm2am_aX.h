 ...
 * mat2blk prototypes
 */
void ATL_zcm2am_aX_4
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zrm2am_aX_4
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zcm2am_aX_4C
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zrm2am_aX_4C
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
...
void ATL_zrm2am_aX_1C
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zcm2am_aX_6
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zrm2am_aX_6
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zcm2am_aX_6C
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zrm2am_aX_6C
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
...
void ATL_zrm2am_aX_2x12C
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zcm2am_aX_20
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zrm2am_aX_20
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zcm2am_aX_20C
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zrm2am_aX_20C
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zcm2am_aX_22
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zrm2am_aX_22
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zcm2am_aX_22C
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
void ATL_zrm2am_aX_22C
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*,TYPE*);
...
static const cm2am_t ATL_AMM_A2BLK_aX[16] =
{
   ATL_zcm2am_aX_4,  /* index 0 */
   ATL_zcm2am_aX_6,  /* index 1 */
   ATL_zcm2am_aX_2x8,  /* index 2 */
   ATL_zcm2am_aX_2x12,  /* index 3 */
   ATL_zcm2am_aX_20,  /* index 4 */
   ATL_zcm2am_aX_22,  /* index 5 */
   ATL_zcm2am_aX_2x12,  /* index 6 */
   ATL_zcm2am_aX_28,  /* index 7 */
   ATL_zcm2am_aX_2x8,  /* index 8 */
...
static const cm2am_t ATL_AMM_AT2BLK_aX[16] =
{
   ATL_zrm2am_aX_4,  /* index 0 */
   ATL_zrm2am_aX_6,  /* index 1 */
   ATL_zrm2am_aX_2x8,  /* index 2 */
   ATL_zrm2am_aX_2x12,  /* index 3 */
   ATL_zrm2am_aX_20,  /* index 4 */
   ATL_zrm2am_aX_22,  /* index 5 */
   ATL_zrm2am_aX_2x12,  /* index 6 */
   ATL_zrm2am_aX_28,  /* index 7 */
   ATL_zrm2am_aX_2x8,  /* index 8 */
...
static const cm2am_t ATL_AMM_B2BLK_aX[16] =
{
...
static const cm2am_t ATL_AMM_BT2BLK_aX[16] =
{
...
static const cm2am_t ATL_AMM_AC2BLK_aX[16] =
{
   ATL_zcm2am_aX_4C,  /* index 0 */
   ATL_zcm2am_aX_6C,  /* index 1 */
   ATL_zcm2am_aX_2x8C,  /* index 2 */
   ATL_zcm2am_aX_2x12C,  /* index 3 */
   ATL_zcm2am_aX_20C,  /* index 4 */
   ATL_zcm2am_aX_22C,  /* index 5 */
   ATL_zcm2am_aX_2x12C,  /* index 6 */
   ATL_zcm2am_aX_28C,  /* index 7 */
   ATL_zcm2am_aX_2x8C,  /* index 8 */
...
static const cm2am_t ATL_AMM_AH2BLK_aX[16] =
{
   ATL_zrm2am_aX_4C,  /* index 0 */
   ATL_zrm2am_aX_6C,  /* index 1 */
   ATL_zrm2am_aX_2x8C,  /* index 2 */
   ATL_zrm2am_aX_2x12C,  /* index 3 */
   ATL_zrm2am_aX_20C,  /* index 4 */
   ATL_zrm2am_aX_22C,  /* index 5 */
   ATL_zrm2am_aX_2x12C,  /* index 6 */
   ATL_zrm2am_aX_28C,  /* index 7 */
   ATL_zrm2am_aX_2x8C,  /* index 8 */
...
static const cm2am_t ATL_AMM_BC2BLK_aX[16] =
{
...
static const cm2am_t ATL_AMM_BH2BLK_aX[16] =
{
