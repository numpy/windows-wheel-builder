#ifndef ATLAS_SsqAMM_PERF_H
   #define ATLAS_SsqAMM_PERF_H

#include "atlas_amm.h"
#define ATL_ssqAMM_NCASES 48
#define ATL_sqAMM_DENOM 1.513238e+04 /* (15132.38)*/ 
#define ATL_sqAMM_MAXMFLOPIDX 47
...
static const float ATL_sqAMM_PERF[48] =   /* % of performance of best kernel */
{
   0.198264,  /* IDX=0, KB=4 */
   0.285163,  /* IDX=1, KB=8 */
...
static const float ATL_sqAMM_TIME[48] =   /* % of performance of best kernel */
{
