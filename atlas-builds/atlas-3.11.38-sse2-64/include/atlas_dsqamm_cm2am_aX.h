...
void ATL_drm2am_aX_2x1
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*);
void ATL_dcm2am_aX_10
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*);
void ATL_drm2am_aX_10
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*);
void ATL_dcm2am_aX_2x12
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*);
void ATL_drm2am_aX_2x12
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*);
void ATL_dcm2am_aX_20
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*);
void ATL_drm2am_aX_20
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*);
void ATL_dcm2am_aX_22
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*);
void ATL_drm2am_aX_22
   (ATL_CSZT,ATL_CSZT,const SCALAR,const TYPE*,ATL_CSZT,TYPE*);
...
static const cm2am_t ATL_AMM_A2BLK_aX[22] =
{
   ATL_dcm2am_aX_4,  /* index 0 */
   ATL_dcm2am_aX_6,  /* index 1 */
   ATL_dcm2am_aX_2x8,  /* index 2 */
   ATL_dcm2am_aX_10,  /* index 3 */
   ATL_dcm2am_aX_2x12,  /* index 4 */
   ATL_dcm2am_aX_20,  /* index 5 */
   ATL_dcm2am_aX_22,  /* index 6 */
   ATL_dcm2am_aX_28,  /* index 7 */
   ATL_dcm2am_aX_2x8,  /* index 8 */
...
static const cm2am_t ATL_AMM_AT2BLK_aX[22] =
{
   ATL_drm2am_aX_4,  /* index 0 */
   ATL_drm2am_aX_6,  /* index 1 */
   ATL_drm2am_aX_2x8,  /* index 2 */
   ATL_drm2am_aX_10,  /* index 3 */
   ATL_drm2am_aX_2x12,  /* index 4 */
   ATL_drm2am_aX_20,  /* index 5 */
   ATL_drm2am_aX_22,  /* index 6 */
   ATL_drm2am_aX_28,  /* index 7 */
   ATL_drm2am_aX_2x8,  /* index 8 */
...
static const cm2am_t ATL_AMM_B2BLK_aX[22] =
{
   ATL_dcm2am_aX_1,  /* index 0 */
   ATL_dcm2am_aX_1,  /* index 1 */
...
static const cm2am_t ATL_AMM_BT2BLK_aX[22] =
{
   ATL_drm2am_aX_1,  /* index 0 */
   ATL_drm2am_aX_1,  /* index 1 */
